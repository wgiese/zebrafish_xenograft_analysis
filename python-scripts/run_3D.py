...
macrophage_properties_df = pd.read_csv("/home/wgiese/Data/zebrafish_xenograft/output_data/threshold_sauvola/macrophage_properties_annotated.csv", index_col=0)
